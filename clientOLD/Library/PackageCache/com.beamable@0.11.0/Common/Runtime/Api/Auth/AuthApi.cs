...
namespace Beamable.Common.Api.Auth
{
   ...
   /// <summary>
   /// This class defines the %UserBundle which combines %User and %TokenResponse.
   /// 
   ...
   /// <summary>
   /// This class defines the main entry point for the %User feature.
   /// 
   /// [img beamable-logo]: https://landen.imgix.net/7udgo2lvquge/assets/xgh89bz1.png?w=400 "Beamable Logo"
   /// 
   /// #### Related Links
   ...
   /// <summary>
   /// This class defines the functionality for the %TokenResponse for the %AuthService.
   /// 
   /// [img beamable-logo]: https://landen.imgix.net/7udgo2lvquge/assets/xgh89bz1.png?w=400 "Beamable Logo"
   /// 
   /// #### Related Links

...
namespace Beamable.Common.Api.Groups
{
    public class GroupsApi : IGroupsApi
    {
        ...
        public Promise<EmptyResponse> Donate(long group, long recipientId, long amount)
        {
            return Requester.Request<EmptyResponse>(
               Method.PUT,
               $"/object/groups/{group}/donations",
               new MakeDonationRequest(recipientId, amount)
            );
        }
    ...
    public class MakeDonationRequest
    {
        ...
        public MakeDonationRequest(long recipientId, long amount)
        {

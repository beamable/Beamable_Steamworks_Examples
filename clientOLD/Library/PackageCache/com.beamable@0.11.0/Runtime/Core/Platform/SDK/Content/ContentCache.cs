...
namespace Beamable.Content
{
   ...
   {
      private readonly Dictionary<string, ContentCacheEntry<TContent>> _cache = new Dictionary<string, ContentCacheEntry<TContent>>();
      ...
      {
         return $"{requestedInfo.contentId}:{requestedInfo.version}";
      }

...
namespace Beamable.Server.Editor.DockerCommands
{
   ...
   public abstract class DockerCommand
   {
      ...
      public static bool DockerNotInstalled { get; protected set; }
#if UNITY_EDITOR && !UNITY_EDITOR_WIN
         public const string DOCKER_LOCATION = "/usr/local/bin/docker"; // TODO: pull this out into a config. BEAM-1178
      #else
      ...
      async void Run(string command)
      {
         ...
         _process.StartInfo.Arguments = $"/C {command}";  //  "/C " + command + " > " + commandoutputfile + "'"; // TODO: I haven't tested this since refactor.
               ...
               EventHandler eh = (s, e) =>
               {
                  ...
                  DockerNotInstalled = _process.ExitCode == PROCESS_NOT_FOUND_EXIT_CODE;
